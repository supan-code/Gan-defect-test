...
from utils import modify_checkpoint
from load import DefectData
import os
...
# super parmeters
class Config(object):
    data_path = r'/home/wl-sp/Downloads/data_full/focusight1_round1_train_part1/OK_Images'
    train_path = r'/home/wl-sp/Downloads/data_full/focusight1_round1_train_part1/'
    val_path = r'/home/wl-sp/Downloads/data_full/focusight1_round1_train_part1/'
    save_path = '/home/wl-sp/Downloads/GAN_defect/imgs/0430'
    work_dir = '/home/wl-sp/Downloads/GAN_defect/workdirs/0430'
    val_save_path = '/home/wl-sp/Downloads/GAN_defect/imgs/0430-val'
...
def train(opt):
    transforms = tv.transforms.Compose([
        tv.transforms.Resize(opt.image_size),    # 128 x 128
        tv.transforms.CenterCrop(opt.image_size),
        # tv.transforms.ToTensor(),
        DefectAdder(mode=opt.defect_mode, defect_shape=('line', 'square'), normal_only=False),
        ToTensorList(),
        NormalizeList(opt.mean, opt.std),
    ])

    # dataset = tv.datasets.ImageFolder(opt.train_path, transform=transforms)
    dataset = DefectData(opt.data_path, transform=transforms, train=True)
    ...
    if opt.validate:
        val_transforms = tv.transforms.Compose([
            ...
            tv.transforms.CenterCrop(opt.image_size),
            # tv.transforms.ToTensor(),
            DefectAdder(mode=opt.defect_mode, defect_shape=('line', 'square'), normal_only=True),
            ToTensorList(),
            NormalizeList(opt.mean, opt.std),
        ...
        val_dataset = DefectData(opt.data_path, transform=transforms, train=False)
    ...
    optimizer_g = optim.Adam(netg.parameters(), opt.lrg, betas=(opt.beta1, 0.999))  # beta1 = 0.5
    ...
    scheduler_g = torch.optim.lr_scheduler.MultiStepLR(optimizer_g, milestones=opt.steps, gamma=0.1)  # steps=[100, 200]
