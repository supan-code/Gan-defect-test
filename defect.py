mport torchvision.transforms.functional as TF
...
class DefectAdder(object):
    def __init__(self, mode='geometry', size_range=(0.05, 0.6), defect_shape=('circle', 'square'), normal_only=False):
        ...
        self.normal_only = normal_only  # True
...
class NormalizeList(object):
    ...
    def __call__(self, tensors):
        ...
        for i in range(len(tensors) - 1):
            tensors[i] = TF.normalize(tensors[i], self.mean[i], self.std[i], self.inplace)
        return tensors
